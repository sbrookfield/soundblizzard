...
def on_playbutton_click(self, widget):
	...
	#	playbutton.set_label('fart')
def on_position_change(self, pos, dur):
...
def is_progress_bar(self, widget):
	...
	self.progress_bars.append(widget)
...
def is_info_label(self, widget):
	self.info_labels.append(widget)
...
def __init__(self, gui):
	...
	self.builder = gtk.Builder()
	self.builder.add_from_file('skins/media_view.glade')
